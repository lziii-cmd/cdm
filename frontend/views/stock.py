...
class MouvementsListView(FrontendView):
    ...
    inventory_view = True
    agent_perm_key = 'perm_mouvements'
...
class StockCourantListView(FrontendView):
    ...
    inventory_view = True
    agent_perm_key = 'perm_stock_courant'
...
class StockActuelListView(FrontendView):
    ...
    inventory_view = True
    agent_perm_key = 'perm_stock_actuel'
...
class SortiesStockListView(FrontendView):
    ...
    inventory_view = True
    agent_perm_key = 'perm_sorties_stock'
...
class TransfertsListView(FrontendView):
    ...
    inventory_view = True
    agent_perm_key = 'perm_transferts'
...
class SortiesDefinitivesListView(FrontendView):
    ...
    inventory_view = True
    agent_perm_key = 'perm_sorties_definitives'
