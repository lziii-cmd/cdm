...
urlpatterns = [
    ...
    # Gestion agents (chef de service)
    path('agents/', views.AgentListView.as_view(), name='gestion_agents'),
    path('agents/nouveau/', views.AgentCreateView.as_view(), name='gestion_agent_create'),
    path('agents/<int:pk>/permissions/', views.AgentPermissionsEditView.as_view(), name='gestion_agent_permissions'),

    # Gestion utilisateurs (superadmin)
    path('users/', views.UserListView.as_view(), name='users'),
    path('users/nouveau/', views.UserCreateView.as_view(), name='user_create'),
